    ...
    public GatewayResponse handleRequest(Object map , Context context) {
    	...
    	try{
    		...
    		if(StringUtils.equalsIgnoreCase(httpMethod, "OPTIONS")){
	    		...
	    		final String callType = objectEle.getString("calType");
	    		if(StringUtils.equals(callType, "LTCG")){
	    			message = LTCG.getLTCGData(objectEle).toString();
	    		}else{
